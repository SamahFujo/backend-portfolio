...
#                 "verdict": {
#                     "type": "string",
#                     "enum": ["yes", "no", "not_enough_evidence"] if is_yes_no else ["supported", "not_enough_evidence"],
#                 },
#                 "answer": {"type": "string"},
#                 "bullets": {
#                     "type": "array",
...
#         chain = [getattr(settings, "OLLAMA_PRIMARY_MODEL", "qwen2.5-coder:7b")] + \
#             getattr(settings, "OLLAMA_FALLBACK_MODELS", [])
...
#                 "verdict": "not_enough_evidence",
#                 "answer": (
#                     f"Answer model is temporarily unavailable ({meta.get('error')}). "
